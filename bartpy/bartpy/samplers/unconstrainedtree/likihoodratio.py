...
class UniformTreeMutationLikihoodRatio(TreeMutationLikihoodRatio):
    ...
    def __init__(self,
        ...
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio __init__")
        if prob_method is None:
            prob_method = [0.5, 0.5]
        self.prob_method = prob_method
        print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio __init__")

    def log_transition_ratio(self, tree: Tree, mutation: TreeMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_transition_ratio")
        if mutation.kind == "prune":
            mutation: PruneMutation = mutation
            output = self.log_prune_transition_ratio(tree, mutation)
            print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_transition_ratio")
            return output
    ...
    def log_tree_ratio(self, model: Model, tree: Tree, mutation: TreeMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_tree_ratio")
        if mutation.kind == "grow":
            mutation: GrowMutation = mutation
            output = self.log_tree_ratio_grow(model, tree, mutation)
            print("exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_tree_ratio")
            return output
        if mutation.kind == "prune":
            mutation: PruneMutation = mutation
    ...
    def log_likihood_ratio(self, model: Model, tree: Tree, proposal: TreeMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_likihood_ratio")
        if proposal.kind == "grow":
            proposal: GrowMutation = proposal
            output = self.log_likihood_ratio_grow(model, proposal)
            print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_likihood_ratio")
            return output
    ...
    def log_likihood_ratio_grow(model: Model, proposal: TreeMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_likihood_ratio_grow")
        ...
        print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_likihood_ratio_grow")
        return output

    @staticmethod
    def log_likihood_ratio_prune(model: Model, proposal: TreeMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_likihood_ratio_prune")
        ...
        print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_likihood_ratio_prune")
        return output

    def log_grow_transition_ratio(self, tree: Tree, mutation: GrowMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_grow_transition_ratio")
        ...
        print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_grow_transition_ratio")
        return output

    def log_prune_transition_ratio(self, tree: Tree, mutation: PruneMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_prune_transition_ratio")
        ...
        print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_prune_transition_ratio")
        return output

    @staticmethod
    def log_tree_ratio_grow(model: Model, tree: Tree, proposal: GrowMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_tree_ratio_grow")
        ...
        print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_tree_ratio_grow")
        return output

    @staticmethod
    def log_tree_ratio_prune(model: Model, proposal: PruneMutation):
        print("enter bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_tree_ratio_prune")
        ...
        output = numerator - denominator
        print("-exit bartpy/bartpy/samplers/unconstrainedtree/likihoodratio.py UniformTreeMutationLikihoodRatio log_tree_ratio_prune")
        return output
